{
    ...
    "name": "${subject.findValue("label")?json_string}",
    ...
    "ccys": [<#list subject.find("hasCurrency") as currency>
        {
    ...
    "cap": {<#list subject.find("hasCapital") as capital>
    ...
    "pop": ${subject.findValue("hasPopulation")},
    ...
    "zone": [<#list subject.find("hasTimeZone") as zone>
        "${zone.findValue("label")?json_string}"<#sep>,</#sep>
    </#list>],
    "conts": [<#list subject.findValues("belongsToContinent") as continent>
