...
"Director": [<#list subject.find("director") as director>
    {
    "firstName": "${director.findValue("name")?keep_before_last(" ")}",
    "lastName": "${director.findValue("name")?keep_after_last(" ")}"
    }<#sep>,</#sep>
</#list>],
...
"Actors": [<#list subject.find("actor") as actor>
    {
    "firstName": "${actor.findValue("name")?keep_before_last(" ")}",
    "lastName": "${actor.findValue("name")?keep_after_last(" ")}"
    }<#sep>,</#sep>
</#list>],
"Response": "True",
"Type": "Movie",
...
"Writer": [<#list subject.find("writer") as writer>
    {
    "firstName": "${writer.findValue("name")?keep_before_last(" ")}",
    "lastName": "${writer.findValue("name")?keep_after_last(" ")}"
    }<#sep>,</#sep>
</#list>]
}