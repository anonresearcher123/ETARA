...
"Ratings": [
    <#if subject.findValue("metascore")??>{
    "Value": "${subject.findValue("metascore")?json_string}",
    "Source": "Metascore"
    },</#if>
    <#if subject.findValue("imdb_rating")??>
    {
    "Value": "${subject.findValue("imdb_rating")?json_string}",
    "Source": "IMDB Rating"
    },</#if>
    <#list subject.find("review") as review>
    {
...
"Director": [<#list subject.find("director") as director>
    "${director.findValue("name")?json_string}"<#sep>,</#sep></#list>
],
...
"Writer": [<#list subject.find("writer") as writer>
    "${writer.findValue("name")?json_string}"<#sep>,</#sep>
</#list>]
}
]
}